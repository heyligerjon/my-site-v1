        ...
        return (
            <main className='flex flex-col items-center w-full'>
                <div id='about' className={`container flex flex-col self-center items-center w-full mt-[57px]`}>
                    <h1 id='about-header' className='z-10 section-header mt-8 w-fit gradient-text'>About Me</h1>
        ...
        return (
            <main className='flex flex-col items-center w-full'>
                <div id='about' className={`container flex ${flexDir} justify-between pt-[57px]`}>
                    ...
                    <h1 id='about-header' className='section-header mt-8 mb-4 w-fit gradient-text'>About Me</h1>
                    <div className='absolute flex text-sm self-center w-1/2 left-[37.5%] border-2 border-dark p-4'>
                        <p>
                            {blurb}
                        </p>
                    </div>
